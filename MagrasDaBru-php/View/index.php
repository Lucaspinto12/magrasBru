...
session_start();
			...
			if(!isset($_SESSION["usuarioEmail"]) ||!isset($_SESSION["usuarioSenha"]) || !isset($_SESSION["usuarioNome"]) ){
          ...
          <div class="offcanvas offcanvas-end" style="background-color: white;" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            ...
            <div class="offcanvas-body">
              <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="ficha_de_avaliacao.php">Cadastro</a>
                </li>
...
<main>
  <div class="container marketing">
    ...
    <div class="row">
      <div class="col-lg-4">
        <img src="img/biomedica.jpg"svg class="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#777"/></svg>
        <?php 
  ...
  $usuario= "SELECT `nome`, `email`, `senha` FROM `usuario` WHERE nome like '%Solange%'";
    
	$resultadoUsuario = mysqli_query($conn, $usuario);
        
	while($rowUsuario = mysqli_fetch_assoc($resultadoUsuario)){
	
 ?>
        <h2><?php echo $rowUsuario['nome'];?></h2>
        <p>Biomedica</p>
        <p><a class="btn btn-secondary" href="agenda_sol.php">Ver Agenda</a></p>
      </div><!-- /.col-lg-4 -->
      <div class="col-lg-4">
  ...
  $usuario= "SELECT `nome`, `email`, `senha` FROM `usuario` WHERE nome like '%admin%'";
 ...
 ?>
        <h2><?php echo $rowUsuario['nome'];?></h2>
        <p>Massagista</p>
        <p><a class="btn btn-secondary" href="agenda_sol.html">Ver Agenda</a></p>
      </div><!-- /.col-lg-4 -->
      <div class="col-lg-4">
  ...
  $usuario= "SELECT `nome`, `email`, `senha` FROM `usuario` WHERE nome like '%Drieli%'";
